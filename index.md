...
Button Facade | Changes the appearance of action bars and buttons.
Capping | Arena countdown timer and essential battleground information.
...
Interrupt Bar | Lists the cooldowns of enemy interrupt abilities.
...
Monkey Speed | Allows you to see how fast you are moving in-game.
Move Anything | Use in conjunction with eAlign. Allows you to move and hide the default Blizzard UI.
Need To Know | Displays cooldowns and when spells are usable in a very sleek way.
...
Tidy Plates + Clean Plates | Allows for the targeting of Tremor Totems. Can be configured for all totems with many different indicators.
